...
//EXTRAAAA 
// Referencias al buscador y al botón
const buscador = document.getElementById('buscador');

// Función para filtrar productos
function buscarProductos() {
    const query = buscador.value.toLowerCase();
    const productosFiltrados = baseDeDatos.flatMap(cat => 
        cat.productos.filter(prod => 
...
// Agregar evento al botón y al campo de texto
buscador.addEventListener('input', buscarProductos); // Filtrar en tiempo real
